...
public class UserTestData {
    ...
    public static final User USER2 =
            new User(USER2_ID, "Anna", "bar@gmail.com", "s3cr3t",
    ...
    public static final String USER_JSON_NEW = "{\"name\":\"Fedr\",\"email\":\"fedya@gmail.com\",\"password\":\"qwerty123\"," +
            "\"registered\":\"2020-10-03T10:03:02\"}";

    public static final String USER_JSON_UPDATED = "{\"id\":100001,\"name\":\"UpdatedName\",\"email\":\"mrbugsy@mail.ru\"," +
            "\"password\":\"pass123\",\"registered\":\"2020-02-05T13:05:11\"}";

    public static User getNew() {
        return new User(null, "Fedr", "fedya@gmail.com", "qwerty123",
                LocalDateTime.of(2020, 10, 3, 10, 3, 2), true,
                EnumSet.of(Role.USER));
    }
